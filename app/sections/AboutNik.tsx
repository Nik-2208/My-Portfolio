      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight uppercase tracking-tight">
              Full Stack <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">AI Engineer</span>
            </h2>
            <p className="text-gray-400 text-base md:text-lg leading-relaxed mb-10 font-sans">
              As a fast learner, disciplined thinker, and detail-oriented engineer, my goal is bridging humans and AI. I build predictive models, AI-powered applications, and scalable intelligent systems with a strong commitment to continuous improvement.
            </p>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 md:right-4 bottom-4 md:bottom-10 p-4 md:p-5 rounded-2xl border border-cyan-400/30 bg-black/60 backdrop-blur-lg will-change-transform font-mono"
            >
              <div className="flex items-center gap-3 mb-1">
                <div className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
                <span className="text-cyan-400 text-[10px] uppercase tracking-widest font-bold">Status</span>
              </div>
              <div className="text-lg md:text-xl font-bold text-white uppercase tracking-tight">UNIQUELY RARE</div>
            </motion.div>
          </motion.div>
        </div>
      </div>
